...
def pca(data, top_n):
    ...
    sort_index = np.argsort(eigval)[::-1] #descending order
...
data1 = np.loadtxt("pca_data.txt", delimiter=" ")
...
data2 = np.loadtxt("em_data.txt")
#print(data2.shape)
em = em_poisson(2)
em.find_em(data2)

print("Estimated mean number of children:", em.lambdas)

print("Proportion of families with family planning:", em.pi[0])
